<template>
  ...
  <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
        <el-form-item label="搜索字段" prop="competitionName">
          <el-select v-model="SelectQueryParams" placeholder="请选择搜索字段">
              <el-option
        ...
        <el-form-item>
          <el-input v-model="SelectQueryParamsValue" placeholder="请输入搜索内容" />
        </el-form-item>
        <el-form-item>
    ...
    handleQuery() {
      this.queryParams.pageNum = 1
       if (this.SelectQueryParams) {
         this.$set(this.queryParams, this.SelectQueryParams, this.SelectQueryParamsValue);
       }
      console.log("SelectQueryParams:"+this.SelectQueryParams)
      console.log("SelectQueryParamsValue:"+this.SelectQueryParamsValue)
